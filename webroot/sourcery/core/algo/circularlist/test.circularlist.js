_.ambient.module("test.circularlist")
    .ontest("circularlist", function(_) {
        ...
        var node3 = _.model.circularlistnode("3").assign(list, -1)
        var node1 = _.model.circularlistnode("1").assign(list, 1) 

        var node5 = _.model.circularlistnode("5").assign(list) 

        var node2 = _.model.circularlistnode("2").assign(node3)
        var node4 = _.model.circularlistnode("4").assign(node5)   
        ...
        var node1 = _.model.circularlistnode("1").assign(node2)
        var node5 = _.model.circularlistnode("5").assign(node4, 1)
        var node3 = _.model.circularlistnode("3").assign(node4)

        this.assert(list.debugout(), ["1","2","3","4","5"], "Linked list: Reading items")
        this.assert(list.debugvalidate(), null, "After reading items")

        _.model.circularlistnode("0").assign(list, 1)
        _.model.circularlistnode("6").assign(list)
