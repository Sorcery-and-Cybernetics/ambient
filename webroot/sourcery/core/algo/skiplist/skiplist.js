...
//
// orderindex is the 1-based position of a node.
// relativeindex is used to move from a node: -1 is before, 1 is after, 0 is the node itself.
// Insertion always places the new node before the selected node.
// Roots are treated as nodes for all operations.
//**************************************************************************************************
