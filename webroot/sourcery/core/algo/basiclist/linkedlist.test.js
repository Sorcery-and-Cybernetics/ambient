_.ambient.module("linkedlist.test")
    .ontest("linkedlist", function(_) {
        var list = _.make.linkedlist()
        
        var node3 = _.make.linkedlistnode("3").assign(list, -1)
        var node1 = _.make.linkedlistnode("1").assign(list, 1) 
        var node5 = _.make.linkedlistnode("5").assign(list) 

        var node2 = _.make.linkedlistnode("2").assign(node3)
        var node4 = _.make.linkedlistnode("4").assign(node3, 1)   
        ...
        var node1 = _.make.linkedlistnode("1").assign(node2)
        var node5 = _.make.linkedlistnode("5").assign(node4, 1)
        var node3 = _.make.linkedlistnode("3").assign(node4)
        ...
        _.make.linkedlistnode("0").assign(list, 1)
        _.make.linkedlistnode("6").assign(list)
