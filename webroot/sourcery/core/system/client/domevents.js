//*****************************************************************************************************************
// domevents - Copyright (c) 2025 Sorcery and Cybernetics. All rights reserved.
//
...
_.define.event("domevent", function () {
    ...
    this.create = function (source, event) {
        ...
        //environ.button remembers last pressed button and will add this to the event
        switch (event.type) {
            case "touchstart":
                this.currentbutton = 1
                _.environ.button |= this.currentbutton
                break
