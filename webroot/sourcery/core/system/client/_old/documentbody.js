_.define.control("documentbody", function (supermodel) {
    return {
        ...
        , width: 0
        , height: 0
        , minheight: _.config.ui.layout.minheight || 800
        , debug: false
        , isroot: true
        , rescale: false
        ...
        //, foreachcontrol: function (next) {
        //    _.foreach(this.nodes, next)
        //    return this
        //}
        ...
        , onresize: _.signal(function (event) {
            this.autozoom()
        ...
        , findcontrol: function (path, childindex) {
